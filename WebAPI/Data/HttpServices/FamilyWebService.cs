...
namespace WebClient.Data
{
    public class FamilyWebService : IFamilyService
    {
        ...
        {
            return _fileContext.GetFamilies();
        }
        
        public async Task<Family> GetFamilyAsync(int id)
        {
            return _fileContext.GetFamilies().FirstOrDefault(t => t.Id == id);
        }
        ...
        {
            Family toRemove = _fileContext.Families.Include(family => family.Adults).Include( family => family.Children).Include(family => family.Pets).First(f => f.Id == familyId);
        ...
        public async Task<Family> UpdateAsync(Family family)
        {
            ...
            int index = _fileContext.GetFamilies().IndexOf(toUpdate);
            _fileContext.GetFamilies()[index] = toUpdate;
            _fileContext.SaveChanges();
            return toUpdate;
        }
